...
public static class DataSeeder
{
    public static void Seed(ModelBuilder modelBuilder)
    {
        var hotels = new[]
        {
            new Hotel { HotelId = Guid.Parse("11111111-0000-0000-0000-000000000001"), Name = "Swissôtel The Bosphorus Istanbul", Destination = "Istanbul", Latitude = 41.04350m, Longitude = 29.00810m, BaseRating = 9.2m, TotalReviews = 1284, IsActive = true, ImageUrl = "https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=800&q=80", Description = "Perched above the Bosphorus Strait with panoramic views of two continents, Swissôtel The Bosphorus combines Swiss precision with Istanbul's timeless elegance. The hotel features award-winning spa facilities, multiple fine-dining restaurants, and a rooftop infinity pool overlooking the historic skyline." },
